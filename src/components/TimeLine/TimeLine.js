...
const Timeline = () => {
  ...
  return (
    <Section id="about">
      ...
      <SectionText>
        Soy Ingeniero de Sistemas, programador y desarrollador de software, mi objetivo profesional es brindar soluciones adaptada a las necesidades de los clientes.
      </SectionText>
